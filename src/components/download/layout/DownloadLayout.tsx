...
export interface DownloadDataProps<ItemT extends UI.DownloadableItemInfo = UI.DownloadableItemInfo> {
...
export const DownloadLayout: React.FC<DownloadLayoutProps> = props => {
  ...
  const menuItems = sections
    .map(s => getMenuItem(s, activeSectionKey, setActiveSectionKey, t));
