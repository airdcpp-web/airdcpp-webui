import { createAppStore, StoreInitProps } from 'context/StoreContext';
...
export const createMockAppStore = (
  initProps: StoreInitProps,
  ...
  return {
    appStore: createAppStore(initProps),
    mocks: {
      hub,
      privateChat,
      filelist,
