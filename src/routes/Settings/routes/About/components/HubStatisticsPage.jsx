  ...
  render() {
    ...
    return (
      <div className="ui grid two column">
        ...
        <Row title="Unique users" text={ `${stats.unique_users} (${formatPercentage(stats.unique_users, stats.total_users)})` }/>
        <Row title="Active users" text={ `${stats.active_users} (${formatPercentage(stats.active_users, stats.unique_users)})` }/>
        <Row title="Total share" text={ formatSize(stats.total_share) }/>
        <Row title="Average share per user" text={ formatSize(formatAverage(stats.total_share, stats.unique_users)) }/>
