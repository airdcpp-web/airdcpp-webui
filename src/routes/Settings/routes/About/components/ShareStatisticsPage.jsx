  ...
  render() {
    ...
    return (
      <div className="ui grid two column">
        ...
        <Row title="Average files per directory" text={ ValueFormat.formatAverage(stats.total_file_count, stats.total_directory_count) }/>
        ...
        <Row title="TTH searches" text={ ValueFormat.formatPercentage(stats.tth_searches, stats.total_searches) }/>
        <Row title="Text searches" text={ stats.recursive_searches + ' (' + stats.unfiltered_recursive_searches_per_second.toFixed(2) + ' matched per second)' }/>
        <Row 
          title="Filtered text searches" 
          text={ 
            ValueFormat.formatPercentage(stats.filtered_searches, stats.recursive_searches) + 
      ' (' + 
      ValueFormat.formatPercentage(stats.recursive_searches_responded, stats.recursive_searches - stats.filtered_searches) + 
