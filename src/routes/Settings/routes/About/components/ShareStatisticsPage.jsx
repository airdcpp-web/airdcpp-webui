  ...
  render() {
    ...
    return (
      <div className="ui grid two column">
        ...
        <Row title="Total files" text={ `${stats.total_file_count} (${formatPercentage(stats.unique_file_count, stats.total_file_count)} unique)` }/>
        <Row title="Total directories" text={ stats.total_directory_count }/>
        <Row title="Average file age" text={ averageFileAge }/>
        <Row title="Average files per directory" text={ formatAverage(stats.total_file_count, stats.total_directory_count) }/>
