...
export const useSidebarEffect = (sidebarRoutes: RouteItem[], props: RouteComponentProps) => {
  const [ mainLayoutLocation, setMainLayoutLocation ] = useState<Location | undefined>(undefined);
